  ...
  ({ barber: b, index, onEdit, onToggle, onDelete }) => (
    <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.04 }}
      ...
      <div className="flex items-start gap-4">
        <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 font-bold text-[18px] text-black overflow-hidden border border-white/10"
          style={{ backgroundColor: b.avatar_url ? 'transparent' : b.color }}>
          {b.avatar_url ? (
